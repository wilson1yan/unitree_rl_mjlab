...
from unitree_rl_mjlab.tasks.tracking.config.g1.env_cfgs import unitree_g1_flat_tracking_env_cfg
from unitree_rl_mjlab.tasks.tracking.config.g1_23dof.env_cfgs import unitree_g1_23dof_flat_tracking_env_cfg
...
def main(
  ...
  if robot == "g1":    # 29 Dof
    ...
    output_dir = "./unitree_rl_mjlab/assets/motions/g1"
  elif robot == "g1_23dof":
    ...
    output_dir = "./unitree_rl_mjlab/assets/motions/g1_23dof"
  else:
